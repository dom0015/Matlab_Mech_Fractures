...
[ POINTS,ELEMENTS,Neumann_boundaries,fractures_cell,fracture_matrice,Dirichlet_boundaries] = multi_fracture_tear_FETI( POINTS,ELEMENTS,fractures_cell ,Neumann_boundaries,fracture_matrice,Dirichlet_boundaries);
[frac_bdflag,frac_normx,frac_normy,fracture_elem_map] = map_fract2elem(POINTS,ELEMENTS,fracture_matrice);
