function [] = wrap_cg_figure(A,node,elem,u0,fractures_positions,p_Dirichlet,lengths)
...
quiver3(xx,yy,xx*0+p_Dirichlet,-tmp1,-tmp2,tmp2*0,1.1,'Color','black','LineWidth',1.4)
