function [map,sub_nodes,sub_elem,sub_material_constants,sub_volume_force,sub_boundary,sub_boundary_val,sub_sizes,glueB,node_map_on_double,plot_func,plot_func2,divide_neumann_boundary]=partition_FETI(nodes,elems,material_constants,volume_force,Neumann_boundaries,N_bound_value,partitions)
...
divide_neumann_boundary=@(x,y)subdomains_Neumann(x,y,map);
