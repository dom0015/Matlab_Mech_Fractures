function [Q,D,PRESSURE,ugrad,iter,x_elast,response_D] = coupled_solver_adaptive(hydro_problem,elast_problem,SMALSE_params,params)
...
while iter<=SMALSE_params.coupling_iter
    ...
    if shift<trashold*0.9
        hydro_problem.const_delta_t=min(hydro_problem.const_delta_t*2,100/max(trashold,trashold_D));
    end
