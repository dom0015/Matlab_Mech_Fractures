function [u,mi,update_data,nout,ncg] = SMALSE_update_new(F,b0,G,Q,c,update_G,u0,mi0,update_data,idx_no_bounds,rel,tol_to_update,rho0,betarho,Gama,M_start,maxiter_cg,type,printres,norms_mat)
